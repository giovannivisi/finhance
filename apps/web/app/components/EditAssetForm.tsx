...
import { EXCHANGE_SUFFIXES, type ApiAsset } from "@lib/api-types";
import {
  assetToFormValues,
  buildAssetPayload,
  ensureKindForType,
...
export default function EditAssetForm({
  ...
  const [form, setForm] = useState<AssetFormValues>(() => assetToFormValues(asset));
  ...
  async function handleSubmit(event: React.FormEvent) {
    ...
    try {
      const response = await fetch(getApiUrl(`/assets/${asset.id}`), {
        method: "PUT",
